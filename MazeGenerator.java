...
/**
 * 
 * @author Dale Seen & Konstantin Dimitrov
 *
 */
public class MazeGenerator
{
	private static final int DEFAULT_DIMENSION = 4;			// The Default Dimension of the maze
	private static final String OUTPUT = "output.txt";		// Name of output.txt file
	...
	public void printOutput()
	{
		try
		{
			...
			for (int i = 0; i < 3; i++)
			{
				...
				out.write("Graph Size: " + index);
				out.newLine();
				out.write("MAZE:");
				System.out.println("MAZE: ");
				out.newLine();
				MazeGenerator maze1 = new MazeGenerator(index);
				maze1.generateMaze();
				String initialMaze = maze1.toStringInitialMaze() + "\r\n";
				out.write(initialMaze);
				System.out.println(initialMaze);
				maze1.solveMazeBFS();
				String bfs = maze1.toStringOrderMaze() + "\r\n";
				out.write("BFS:\r\n");
				System.out.println("BFS:");
				out.write(bfs);
				System.out.println(bfs);
				String bfsSolution = maze1.toStringSolvedMaze() + "\r\n";
				out.write(bfsSolution);
				System.out.println(bfsSolution);
				maze1.reset();
				maze1.solveMazeDFS();
				String dfs = maze1.toStringOrderMaze() + "\r\n";
				out.write("DFS:\r\n");
				System.out.println("DFS:");
				out.write(dfs);
				System.out.println(dfs);
				String dfsSolution = maze1.toStringSolvedMaze();
				out.write(dfsSolution);
				System.out.print(dfsSolution);
				out.write("======================\r\n");
	...
	{
		MazeGenerator myMaze = new MazeGenerator();
		myMaze.printOutput();
		/**
		MazeGenerator maze1 = new MazeGenerator();
		maze1.generateMaze();
		System.out.println("Initial Maze of 4: ");
		...
		maze2.generateMaze();
		System.out.println("Initial Maze of 6: ");
		System.out.println(maze2.toStringInitialMaze());
		maze2.solveMazeBFS();
		System.out.println("BFS: ");
		System.out.println(maze2.toStringOrderMaze());
		System.out.println("BFS Solution: ");
		System.out.println(maze2.toStringSolvedMaze());
